...
export const saitamaSpots: Spot[] = [
    ...
    {
        id: '2020', name: '東武動物公園', area: 'saitama', genre: 'activity', budget: 'mid', weather: 'sunny',
        description: '動物園と遊園地が融合したハイブリッドレジャーランド。ホワイトタイガーがいる。',
        locationLink: 'https://goo.gl/maps/tobuzoo',
    ...
    {
        id: '2021', name: 'ジョンソンタウン', area: 'saitama', genre: 'shopping', budget: 'low', weather: 'sunny',
        description: '元米軍住居跡地を利用したアメリカンな街並み。カフェや雑貨店が並ぶ。',
        locationLink: 'https://goo.gl/maps/johnsontown',
    ...
    {
        id: '2024', name: '首都圏外郭放水路', area: 'saitama', genre: 'cultural', budget: 'low', weather: 'rainy_ok',
        description: '「地下神殿」と呼ばれる世界最大級の地下放水路。見学会は要予約。',
        locationLink: 'https://goo.gl/maps/ryukyukan',
        imageUrl: 'https://images.unsplash.com/photo-1518182170546-07da61d56cc9?auto=format&fit=crop&q=80&w=800',
        vibes: ['exciting', 'cultural'],
        address: '埼玉県春日部市上金崎720'
    },
    {
    ...
    {
        id: '2026', name: '羊山公園（芝桜の丘）', area: 'saitama', genre: 'nature', budget: 'low', weather: 'sunny',
        description: '春には芝桜が丘一面を覆い尽くす。秩父のシンボル武甲山も望める。',
        locationLink: 'https://goo.gl/maps/hitsujiyama',
        imageUrl: 'https://images.unsplash.com/photo-1525127752301-99904d77053e?auto=format&fit=crop&q=80&w=800',
        vibes: ['romantic', 'relax'], // fix nature? 'nature' invalid. -> ['romantic', 'relax']
        // Wait, fixing directly below
    },
    {
        id: '2027', name: '三峯神社', area: 'saitama', genre: 'cultural', budget: 'free', weather: 'sunny',
        description: '関東屈指のパワースポット。雲海が見られることもある。',
        locationLink: 'https://goo.gl/maps/mitsumine',
